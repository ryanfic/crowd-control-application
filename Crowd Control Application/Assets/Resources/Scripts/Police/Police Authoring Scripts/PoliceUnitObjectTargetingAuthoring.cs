...
public class PoliceUnitObjectTargetingAuthoring : MonoBehaviour, IConvertGameObjectToEntity 
{
    ...
    public void Convert(Entity entity, EntityManager dstManager, GameObjectConversionSystem conversionSystem){ 
        //using (BlobAssetStore blobAssetStore = new BlobAssetStore()){ // using causes a lot of errors when it deletes the blobassetstore
            ...
            dstManager.AddComponentData<PoliceUnitTargetNearestIntersection>(entity, new PoliceUnitTargetNearestIntersection{});
